...
def usage():
    print("netcat replacement tools")
    print()
    ...
    print()
    print("Examples: ")
    print("netkitty.py -t 192.168.0.1 -p 5555 -l -c")
    print("netkitty.py -t 192.168.0.1 -p 5555 -l -u=c:\\target.exe")
    print("netkitty.py -t 192.168.0.1 -p 5555 -l -e=\"cat /etc/passwd\"")
    print("echo 'ABCD' | ./netkitty.py -t 192.168.11.12 -p 135")
    sys.exit(0)
